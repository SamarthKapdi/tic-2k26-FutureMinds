  ...
  return (
    <Routes>
      ...
      <Route path="/login" element={
        isAuthenticated
          ? <Navigate to={user?.name ? '/dashboard' : '/profile/setup'} replace />
          : <Layout><Login /></Layout>
      } />
      ...
      <Route path="/blood" element={<ProtectedRoute><Layout><Blood /></Layout></ProtectedRoute>} />
      <Route path="/fund" element={<ProtectedRoute><Layout><Fund /></Layout></ProtectedRoute>} />
      <Route path="/missing" element={<ProtectedRoute><Layout><Missing /></Layout></ProtectedRoute>} />
      <Route path="/map" element={<ProtectedRoute><Layout><MapView /></Layout></ProtectedRoute>} />
      <Route path="/leaderboard" element={<ProtectedRoute><Layout><Leaderboard /></Layout></ProtectedRoute>} />
      
      {/* Informational Public Routes */}
      <Route path="/info/blood" element={<Layout><BloodInfo /></Layout>} />
      <Route path="/info/fund" element={<Layout><FundInfo /></Layout>} />
      <Route path="/info/missing" element={<Layout><MissingInfo /></Layout>} />
      <Route path="/info/map" element={<Layout><MapInfo /></Layout>} />
      ...
      <Route path="/mission" element={<Layout><OurMission /></Layout>} />

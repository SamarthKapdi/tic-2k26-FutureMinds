...
const contactInfo = [
  {
    icon: MapPin,
    title: 'Our Office',
    lines: ['FutureMinds Tech Hub', '123 Innovation Drive, Tech Park', 'Mumbai, Maharashtra 400001'],
    color: 'bg-primary/10',
  ...
  },
  {
    ...
    lines: ['+91 98765 43210', '+91 1800 123 4567 (Toll Free)'],
  ...
  },
  {
    icon: Clock,
    title: 'Working Hours',
    lines: ['Emergency: 24/7 Always Available', 'Office: Mon – Fri, 9 AM – 6 PM'],
    color: 'bg-amber-100',
    ...
    <div className="py-8 sm:py-12">
      ...
      <motion.div {...fadeUp} className="text-center mb-16">
        ...
        <p className="text-lg text-text-secondary max-w-2xl mx-auto">
          Have a question, need help with an emergency, or want to partner with us? We'd love to hear from you.
        </p>
      </motion.div>
      ...
      <div className="grid lg:grid-cols-5 gap-12">
        ...
        >
          ...
          <p className="text-text-secondary leading-relaxed mb-6">
            Whether you want to volunteer as a blood donor, report a missing person, or explore partnership
            opportunities — our team is ready to help.
          </p>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <CheckCircle className="h-5 w-5 text-success shrink-0" />
              <span className="text-sm text-text">Average response time: under 2 hours</span>
            </div>
            <div className="flex items-center gap-3">
              <CheckCircle className="h-5 w-5 text-success shrink-0" />
              <span className="text-sm text-text">24/7 emergency helpline available</span>
            </div>
            <div className="flex items-center gap-3">
              <CheckCircle className="h-5 w-5 text-success shrink-0" />
              <span className="text-sm text-text">Partnership onboarding within 48 hours</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-2xl font-bold font-heading text-text mb-6">Send us a Message</h2>
